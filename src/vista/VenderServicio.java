 ...
 */
public class VenderServicio extends javax.swing.JFrame {

    /**
     * Creates new form VenderServicio
     */
    public VenderServicio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vender servicio");

        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Selecciona el servicio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VenderServicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VenderServicio().setVisible(true);
            }
        });
    }
