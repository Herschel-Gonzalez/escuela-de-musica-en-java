...
public class Surtir extends javax.swing.JFrame {
    ...
    public Surtir() {
        ...
        while (escuelas.next()) {            
            this.escuela.addItem(escuelas.getString("nom_esc"));
        }
        ResultSet productos = consultas.consulta("select nom_pro from producto", conexion);
        while (productos.next()) {            
            this.producto.addItem(productos.getString("nom_pro"));
        }
        
        ResultSet proveedor = consultas.consulta("select razonsocial_prov from proveedor", conexion);
        while (proveedor.next()) {            
            this.proveedor.addItem(proveedor.getString("razonsocial_prov"));
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Surtir");

        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Fecha");

        fecha.setText("2021-12-03");
        ...
        jLabel5.setText("Porcion por unidad");

        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Fecha de caducidad");

        fechaCaducidad.setText("2021-12-03");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(ppu, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel6)
                        .addGap(18, 18, 18)
                        .addComponent(fechaCaducidad, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ...
        contador++;
        if (contador==1) {
        String consulta = "call sp_surtir(?,?,?)";
        String razonsocial_prov = proveedor.getSelectedItem().toString();
        System.out.println(razonsocial_prov);
        ResultSet cve_prov = consultas.consulta("select cve_prov from proveedor where razonsocial_prov='"+razonsocial_prov+"'", conexion);
        String clave = "";
        String nom_esc = escuela.getSelectedItem().toString();
        ResultSet cve_esc = consultas.consulta("select cve_esc from escuela where nom_esc='"+nom_esc+"'", conexion);
        String clave_esc = "";
        try {
            while (cve_prov.next()) {            
            clave = cve_prov.getString("cve_prov");
        }
            while (cve_esc.next()) {                
                clave_esc=cve_esc.getString("cve_esc");
            }
         ...
         String valores[] = new String[]{fecha.getText(),clave,clave_esc};
         consultas.consultaQueAgrega(consulta, conexion, valores);
        }
        
        String consulta = "call sp_renglonsurtir(?,?,?,?,?)";
        ResultSet cve_pro = consultas.consulta("select cve_pro from producto where nom_pro='"+producto.getSelectedItem().toString()+"'", conexion);
        String clave_pro = "";
        try {
            while (cve_pro.next()) {                
                clave_pro = cve_pro.getString("cve_pro");
            }
        ...
        String valores[] = new String[]{fecha.getText(),cantidad.getText(),ppu.getText(),fechaCaducidad.getText(),clave_pro};
        consultas.consultaQueAgrega(consulta, conexion, valores);
         try {
             conexion.getConnection().commit();
             JOptionPane.showMessageDialog(null, "Se ha surtido el producto con exito");
         } catch (SQLException ex) {
